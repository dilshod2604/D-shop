...
import { useSearchByCategoryQuery } from "@/redux/api/search";
...
const ProductsByCategory = () => {
  ...
  const { data: poducts, isLoading } = useSearchByCategoryQuery(
      ...
      <div className="container ">
        <div className="flex flex-col gap-y-6 ">
          <div className="flex gap-x-4">
            ...
            <h1 className="text-red-500 font-bold">{categoryQuery}</h1>
          </div>
